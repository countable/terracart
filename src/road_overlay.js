...
// a soft brown band at 19% alpha, so the rasterized roads can be eyeballed
...
(function (global) {
  ...
  const ALPHA = 0.19;    // 19% — reads as a band without hiding the map
  ...
  //     bend — stacking 19% on 19% into a dark blot. Here the whole network is
