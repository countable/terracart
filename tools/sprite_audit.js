...
const SHEETS = {
  ...
  chest:         { file: 'assets/Objects/chest.png',                         fw: 32, fh: 16, frames: [0] },
...
const SCENARIOS = [
  ...
  { name: 'chest',           key: 'chest',         frameIdx: 0, origin: [0.5, 0.9],  scale: 2.0 },
  { name: 'crate (box)',     key: 'box',           frameIdx: 0, origin: [0.5, 0.9],  scale: 1.7 },
  ...
  { name: 'pole (pillar)',   key: 'pillar',        frameIdx: 0, origin: [0.25, 0.95], scale: 1.0 },
